...
export default function PatientDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-blue-100 bg-white/70 p-6 shadow-sm backdrop-blur-sm">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-1 text-lg text-gray-900">{calculateAge(patient.date_of_birth)} years</p>
          </div>
          <div>
            <p className="text-sm font-medium text-gray-500">Gender</p>
            <p className="mt-1 text-lg capitalize text-gray-900">{patient.gender}</p>
          </div>
          <div>
      ...
      {/* Appointments */}
      <div className="rounded-2xl border border-blue-100 bg-white/70 p-6 shadow-sm backdrop-blur-sm">
        <h2 className="mb-6 text-xl font-semibold text-gray-900">Appointments ({appointments.length})</h2>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">
                          {new Date(apt.created_date).toLocaleDateString("en-US", {
                            weekday: "long",
                            year: "numeric",
                            month: "long",
                            day: "numeric",
                        ...
                        <p className="text-sm text-gray-500">
                          {new Date(apt.created_date).toLocaleTimeString("en-US", {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}
                        </p>
                    ...
                    {apt.services.length > 0 && (
                      <div className="mt-4">
                        <p className="mb-2 text-sm font-medium text-gray-600">Services:</p>
                  ...
                  <div className="ml-4 flex flex-col items-end gap-2">
                    ...
                    {apt.payment && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="font-medium text-gray-900">{formatCurrency(apt.payment.amount)}</span>
                      </div>
                    )}
                  </div>
                </div>
